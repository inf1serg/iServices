      ...
      *  Fecha         : 2020/01/27
      *  Abr.Dev.      :
      *  Objetivo      : Cotizacion Vida. Coberturas
      *
      *
      *  Project Name  :
      *  Work ID       :
      ...
      **---------------------------------------------------------**
      *  COW143FM   Consulta de Descuentos y Recargos             DSPF
      *  CTWEV2     Cotizacion Vida. Coberturas                   PF
     ...
     * Define Archivos
      **---------------------------------------------------------**
     fcow143fm  cf   e             Workstn
     f                                     Sfile(Cow143cwa:NrSfl)
     f                                     InfDs(Iofb)
     fctwev2    if   e           k Disk
     fctw000    if   e           k Disk
     fset069    if   e           k Disk
      ...
      *----------------------------------------------------------------*
     D k1twev2         ds                  likerec(C1wev2:*key)
      ...
      /Free
         ...
         //*--------------------------------------------------------*
          BegSr  HndDtaP10;
            ...
            xxpoco = %Dec(pePoco:6:0);
            xxpaco = %Dec(pePaco:3:0);
            // Carga data de cabecera
            Exsr RtvDtaCab;
         ...
         //*--------------------------------------------------------*
          BegSr  ChgDtaSfl1;
              ...
              *in32 = '1';
              ...
              // asigna campos clave
              Clear k1twev2;
              k1twev2.v2empr = peEmpr;
              k1twev2.v2sucu = peSucu;
              k1twev2.v2nivt = %Dec(peNivt:1:0);
              k1twev2.v2nivc = %Dec(peNivc:5:0);
              k1twev2.v2nctw = %Dec(peNctw:7:0);
              k1twev2.v2rama = %Dec(peRama:2:0);
              k1twev2.v2arse = %Dec(peArse:2:0);
              k1twev2.v2poco = %Dec(pePoco:4:0);
              k1twev2.v2paco = %Dec(pePaco:3:0);
              // Posicionamiento
              Setll %kds(k1twev2:9) CTwev2;
              // Lectura de CTwet1
                 Reade %kds(k1twev2:9) CTwev2;
