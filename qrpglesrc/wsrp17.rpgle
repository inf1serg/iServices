      ...
      * ************************************************************ *
      * WSRP17: QUOM Versión 2                                       *
      *         Preliquidación - Insertar/Eliminar Cobranza Integrada*
      * ------------------------------------------------------------ *
     ...
     D  this                         10a   overlay(PsDs:1)
       ...
       *inlr = *on;
       ...
       if acci = 'I';
         PLQWEB_insertarCobranzaIntegrada( peBase
                                         : peNrpl
                                         : peIvbc
                                         : nche
                                         : peEfvo
       ...
       if acci = 'E';
         PLQWEB_eliminarCobranzaIntegrada( peBase
                                         : peNrpl
                                         : peIvbc
                                         : nche
                                         : peErro
