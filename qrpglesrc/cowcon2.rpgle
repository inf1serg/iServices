     ...
     D                 pi
       ...
       Data = CRLF                                     + CRLF
            + '<b>COWCON2</b>'
            + '<b> Renovación Consorcio (Request)</b>' + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
      ...
      * ------------------------------------------------------------------ *
      * setCOWCON1 : Llamada a Wrapper COWCON1 - Cotizar                   *
      *                                                                    *
      * Retorna *on = Ok / *off = Error                                    *
      * ------------------------------------------------------------------ *
     P setCOWCON1...
     ...
     D                 pi              n
      /free
       ...
       Data = CRLF + CRLF
            + '<b>COWCON1 '
            + 'Cotización Consorcio (Request)</b>'          + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
            + %trim(%char(%time():*iso))                    + CRLF
            + 'PEBASE'                                      + CRLF
      ...
      * ------------------------------------------------------------------ *
      * setErrorCOWCON2 : Llamada a Wrapper COWCON2 - Error.               *
      *                                                                    *
      * Retorna *on = Ok / *off = Error                                    *
      * ------------------------------------------------------------------ *
     P setErrorCOWCON2...
     ...
     D                 pi
      /free
       ...
       Data = '<br><br><b>COWCON2 (Response)</b> : Error' + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
            + %trim(%char(%time():*iso))                  + CRLF
            + 'PEERRO: ' +  %trim(%char(peErro))          + CRLF
