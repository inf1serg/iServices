      ...
      *  Fecha         : 2020/01/22
      *  Abr.Dev.      :
      *  Objetivo      : Consulta de Inspecciones/Rastreadores
      *
      *
      *  Project Name  :
      *  Work ID       :
      ...
      **---------------------------------------------------------**
      *  COW126FM   Consulta de Inspecciones/Rastreadores         DSPF
      *  CTWINS     Cotización Web: Inspecciones/Rastreadores     PF
     ...
     * Define Archivos
      **---------------------------------------------------------**
     fcow126fm  cf   e             Workstn
     f                                     Sfile(Cow126cwa:NrSfl)
     f                                     InfDs(Iofb)
     fctwins    if   e           k Disk
     fctw000    if   e           k Disk
      *---------------------------------------------------------------*
         ...
         //*--------------------------------------------------------*
          BegSr  ChgDtaSfl1;
              ...
              *in32 = '1';
              ...
              // asigna campos clave
              Clear k1twins;
              k1twins.inempr = peEmpr;
              k1twins.insucu = peSucu;
              k1twins.innivt = %Dec(peNivt:1:0);
              k1twins.innivc = %Dec(peNivc:5:0);
              k1twins.innctw = %Dec(peNctw:7:0);
              // Posicionamiento
              Setll %kds(k1twins:5) CTwins;
              // Lectura de CTwins
                 Reade %kds(k1twins:5) CTwins;
