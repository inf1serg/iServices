      ...
      * 01/09/16 - LRG - Se realizaron cambios de parametros         *
     ...
     D @@DsTim         ds                  likeDs( Dsctwtim_t)
       ...
       *inlr = *on;
       ...
       callp COWVEH_cotizarWeb( peBase
                              : peNctw
                              : peRama
                              : peArse
                              : pePoco
       ...
       Data =
              '<br><br><b>COWVEH1 (Response)</b>'      + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
            + %trim(%char(%time():*iso))               + CRLF
