     ...
     H actgrp(*new)
      * ********************************************************* *
      * COWRTV14: Recupera los bienes asegurados(Vehículos)       *
      * ********************************************************* *
      *                                                           *
      * ********************************************************* *

     D COWRTV14        pr                  ExtPgm('COWRTV14')
     ...
     D separa          s            100a   inz(*all'-')
       ...
       *inlr  = *on;
       clear peInfv;
       Data = CRLF                                          + CRLF
            + '<b>COWRTV14_Recupera Bienes Asegurados(Request)</b>'  + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
       ...
       Data =
          '<br><br><b>COWRTV14-Recupera Bienes Asegurados(Response)</b>' + CRLF
          + 'Fecha/Hora: '
          + %trim(%char(%date():*iso)) + ' '
          + %trim(%char(%time():*iso));
       COWLOG_log( peBase : peNctw : Data );
       ...
       for i = 1 to 10;
         ...
         Data =                                        CRLF
              + '&nbsp;TAAJ: ' + %editc(peInfv(i).Taaj:'X') + CRLF;
         COWLOG_log( peBase : peNctw : Data );

         for o = 1 to 200;
           if peInfv(i).Scor(o).cosg = *blanks;
             leave;
           endif;
           Data =                                                CRLF
                + 'SCOR(' + %trim(%char(i)) + ')'              + CRLF
                + '&nbsp;COSG: '+%trim(peInfv(i).Scor(o).cosg) + CRLF
                + '&nbsp;COSD: '+%trim(peInfv(i).Scor(o).cosd) + CRLF
                + '&nbsp;VEFA: '+%trim(peInfv(i).Scor(o).vefa) + CRLF
                + '&nbsp;CANT: '+%editc(peInfv(i).Scor(o).cant:'X') + CRLF
                + 'SCOR'                                    + CRLF;
         COWLOG_log( peBase : peNctw : Data );
       endfor;
