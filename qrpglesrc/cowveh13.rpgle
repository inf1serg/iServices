      ...
      * ************************************************************ *
      * COWVEH13: WebService                                         *
      *           Cotización Autos - wrapper para _cotizar()         *
      * ------------------------------------------------------------ *
      * Jennifer Segovia                         *14-May-2019        *
      * ------------------------------------------------------------ *
      * Modificación:                                                *
      * JSN 27/11/2019 - Se agregan nuevos parametros a la llamada   *
      *                  del cotizador().-                           *
      * ************************************************************ *
     ...
     D @@Scor          ds                  likeds(preguntas_t) dim(200)
       ...
       *inlr = *on;
       ...
       Data =
              '<br><br><b>COWVEH13 (Response)</b>'     + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
            + %trim(%char(%time():*iso))               + CRLF
