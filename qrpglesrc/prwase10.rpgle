     ...
     H actgrp(*new)
      * ********************************************************* *
      * PRWASE10: WebService: wrapper para _insertClausulaV()     *
      * --------------------------------------------------------- *
      * Alvarez Fernando                     07-Abr-2016          *
      * ********************************************************* *

     D PRWASE10        pr                  ExtPgm('PRWASE10')
     ...
     D separa          s            100a   inz(*all'-')
       ...
       *inlr  = *on;
       ...
       Data =
              '<br><br><b>PRWASE10 (Response)</b>'      + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
            + %trim(%char(%time():*iso))              + CRLF
            + 'PENCTW: '       + %editc(peNctw:'X')   + CRLF
