      ...
      * ************************************************************ *
      * WSLSP3 : WebService - Retorna propuestas por intermediario.  *
      * ------------------------------------------------------------ *
      * Sergio Fernandez                              *08/04/2016    *
      * ------------------------------------------------------------ *
      *                                                              *
      * ************************************************************ *
     Fpahsp2    if   e           k disk
     ...
     D   peLprp                            likeds(pahsp3_t) dim(99)
     D   peLprpC                     10i 0
     D   peMore                        n
      ...
      * Retrocedo si es paginado 'R'
       ...
       dow ( ( not finArc ) and ( peLprpC < @@cant ) );
         ...
         if %nullind( swfvdp );
            peLprp(peLprpC).swfvdp = *blanks;
          else;
            peLprp(peLprpC).swfvdp = %char( swfvdp : *iso );
         endif;
         if %nullind( swfvhp );
            peLprp(peLprpC).swfvhp = *blanks;
          else;
            peLprp(peLprpC).swfvhp = %char( swfvhp : *iso );
         endif;
         if %nullind( swfvde );
            peLprp(peLprpC).swfvde = *blanks;
          else;
            peLprp(peLprpC).swfvde = %char( swfvde : *iso );
         endif;
         if %nullind( swfvhe );
            peLprp(peLprpC).swfvhe = *blanks;
          else;
            peLprp(peLprpC).swfvhe = %char( swfvhe : *iso );
         endif;
         ...
         if %nullind( swfpro );
            peLprp(peLprpC).swfpro = *blanks;
          else;
            peLprp(peLprpC).swfpro = %char( swfpro : *iso );
         endif;
