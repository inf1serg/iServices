      ...
      * ************************************************************ *
      * COWROB2: WebService                                          *
      *          Renovación Robo - wrapper para _cotizarWeb()        *
      *                                                              *
      * ------------------------------------------------------------ *
     ...
     D                 pi
       ...
       Data = CRLF                                     + CRLF
            + '<b>COWROB2</b>'
            + '<b> Renovación Robo (Request)</b>'      + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
      ...
      * ------------------------------------------------------------------ *
      * setCOWROB1 : Llamada a Wrapper COWROB1 - Cotizar                   *
      *                                                                    *
      * Retorna *on = Ok / *off = Error                                    *
      * ------------------------------------------------------------------ *
     P setCOWROB1...
     ...
     D                 pi              n
      /free
       ...
       Data = CRLF + CRLF
            + '<b>COWROB1 '
            + 'Cotización Robo (Request)</b>'               + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
            + %trim(%char(%time():*iso))                    + CRLF
            + 'PEBASE'                                      + CRLF
      ...
      * ------------------------------------------------------------------ *
      * setErrorCOWROB2 : Llamada a Wrapper COWROB2 - Error.               *
      *                                                                    *
      * Retorna *on = Ok / *off = Error                                    *
      * ------------------------------------------------------------------ *
     P setErrorCOWROB2...
     ...
     D                 pi
      /free
       ...
       Data = '<br><br><b>COWROB2 (Response)</b> : Error' + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
            + %trim(%char(%time():*iso))                  + CRLF
            + 'PEERRO: ' +  %trim(%char(peErro))          + CRLF
