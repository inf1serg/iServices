      ...
      * ------------------------------------------------------------ *
      * JSN 28/12/2016 Se agrego el campo fins (Fecha de inspección) *
      * ************************************************************ *
     ...
     D separa          s            100a
       ...
       *inlr = *on;
       ...
       Data = 'PEINPS' + CRLF
            ...
            + '&nbsp;FINS: ' + %trim(%char(peInsp.fins)) + CRLF
            + 'PEINSP' + CRLF;
       COWLOG_log( peBase : peNctw : Data );
