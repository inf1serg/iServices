      ...
      *  Fecha         : 2020/01/27
      *  Abr.Dev.      :
      *  Objetivo      : Cotizacion Vida. Componentes
      *
      *
      *  Project Name  :
      *  Work ID       :
      ...
      **---------------------------------------------------------**
      *  COW142FM   Consulta de Cobertura de Vehiculos            DSPF
     ...
     d  peMsgs                       80a
      ...
      /Free
         ...
         //*--------------------------------------------------------*
         //* ChgDtaTab1 - Rutina Carga Datos CTWEV1                 *
         //*--------------------------------------------------------*
          BegSr  ChgDtaTab1;
              ...
              k1twev1.v1poco = %Dec(pepoco:6:0);
              k1twev1.v1paco = %Dec(pepaco:3:0);
              // Lectura de CTwet1
              Chain %kds(k1twev1) CTwev1;
