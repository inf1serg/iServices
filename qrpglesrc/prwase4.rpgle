      ...
      * PRWASE4: WebService                                          *
      *          Propuesta Web                                       *
      *          Wrapper para _insertAseguradoAdicional()            *
      * ------------------------------------------------------------ *
      * ¡¡¡¡¡¡¡¡¡¡¡¡¡¡ A T E N C I O N !!!!!!!!!!!!!!!!!!!!!!!!!!!!! *
      *                                                              *
      * Este webservice queda fuera de uso. Se reemplaza por PRWASE9 *
      *                                                              *
      * ------------------------------------------------------------ *
     ...
     D separa          s            100a
       ...
       *inlr = *on;
       ...
       PRWASE_insertAseguradoAdicional2( peBase
                                       : peNctw
                                       : peAsen
                                       : peNase
                                       : 'FALTA NOMBRE PRWASE4'
                                       : peDomi
                                       : peDocu
                                       : peNtel
                                       : peTiso
