      ...
      * ************************************************************ *
      * PRWBIEN12:WebService                                         *
      *          Propuesta Web                                       *
      *          Wrapper para _dltBeneficiario()                     *
      * ------------------------------------------------------------ *
     ...
     D PRWBIEN12       pr                  ExtPgm('PRWBIEN12')
     ...
     D separa          s            100a
       ...
       *inlr = *on;
       ...
       Data = '<br><br>'
            ...
            + 'PESEBE: '  + %editc(peSebe:'X');
       COWLOG_log( peBase : peNctw : Data );

       PRWBIEN_dltBeneficiario( peBase
                              : peNctw
                              : peRama
                              : peArse
                              : pePoco
