      ...
      *  Fecha         : 2020/01/21
      *  Abr.Dev.      :
      *  Objetivo      : Consulta de Coberturas de Vehiculos
      *
      *
      *  Project Name  :
      *  Work ID       :
      ...
      **---------------------------------------------------------**
      *  COW122FM   Consulta de Cobertura de Vehiculos            DSPF
     ...
     d  peMsgs                       80a
      ...
      /Free
         ...
         //*--------------------------------------------------------*
         //* RtvDtaTab1 - Rutina Recupera datos de Tabla CTwetC     *
         //*--------------------------------------------------------*
          BegSr  ChgDtaTab1;
              ...
              // Posicionamiento
              Clear k1twetc;
              k1twetc.t0empr = peEmpr;
              k1twetc.t0sucu = peSucu;
              k1twetc.t0nivt = %Dec(peNivt:1:0);
              k1twetc.t0nivc = %Dec(peNivc:5:0);
              k1twetc.t0nctw = %Dec(peNctw:7:0);
              k1twetc.t0rama = %Dec(peRama:2:0);
              k1twetc.t0poco = %Dec(pePoco:4:0);
              k1twetc.t0arse = %Dec(peArse:2:0);
              k1twetc.t0Cobl = peCobl;
              // Lectura de archivo CTwetc
              Chain %kds(k1twetc) CTwetc;
