     ...
     H actgrp(*new)
      * ********************************************************* *
      * COWRTV16: Recupera los Bienes asegurados(RGV)   V2        *
      * --------------------------------------------------------- *
      * Sergio Fernandez                    *08-Feb-2021          *
      * ********************************************************* *

     D COWRTV16        pr                  ExtPgm('COWRTV16')
     ...
     D separa          s            100a   inz(*all'-')
       ...
       *inlr = *on;
       ...
       Data = CRLF                                          + CRLF
            + '<b>COWRTV16-Recupera Bienes RGV(Request)</b>'+ CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
       ...
       Data = '<br><br><b>COWRTV16 (Response)</b>'     + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
            + %trim(%char(%time():*iso))               + CRLF;
       COWLOG_log( peBase : peNctw : Data );
       ...
       for i = 1 to 10;
         ...
         Data = 'PEPOCO(' + %trim(%char(i)) + ')' + CRLF
              ...
              + '&nbsp;CTAR: ' + %editc(pePoco(i).Ctar:'X') + CRLF
              + '&nbsp;CTA1: ' + %trim(pePoco(i).Cta1)      + CRLF
              + '&nbsp;CTA2: ' + %trim(pePoco(i).Cta2)      + CRLF
