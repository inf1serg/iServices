     H nomain debug(*YES)
      * ************************************************************ *
      * COWRIV: Cotización Riesgos Varios                            *
      * ------------------------------------------------------------ *
      ...
      *> TEXT('Prorama de Servicio: Cotización Riesgos Varios') <*   *
      *> IGN: DLTMOD MODULE(QTEMP/&N)                   <*           *
      *> IGN: RMVBNDDIRE BNDDIR(HDIILE/HDIBDIR) OBJ((COWRIV)) <*    *
      *> ADDBNDDIRE BNDDIR(HDIILE/HDIBDIR) OBJ((COWRIV)) <*         *
      *> IGN: DLTSPLF FILE(COWRIV)                           <*     *
      * ************************************************************ *
      * Modificaciones:                                              *
      *                                                              *
      * ************************************************************ *
     ...
     P COWRIV_Error    B                   export
     D COWRIV_Error    pi            80a
