      ...
      *          _COWHOG_caracIsValid()                              *
      * ------------------------------------------------------------ *
      * Julio Barranco                           *17-Nov-2015*       *
      * ************************************************************ *
     ...
     D separa          s            100a
       ...
       *inlr = *on;
       ...
       for i = 1 to 50;
          ...
          callp  COWHOG_caracIsValid ( peBase :
                                       peNctw :
                                       peRama :
                                       pePoco :
                                       peCara :
