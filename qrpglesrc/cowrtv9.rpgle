     ...
     H actgrp(*new)
      * ********************************************************* *
      * COWRTV9: Recupera los bienes asegurados(Vehículos) V2     *
      * ********************************************************* *
      * EXT 16/01/2019: Recompilo por cambios en Infvehi2         *
      * ********************************************************* *

     D COWRTV9         pr                  ExtPgm('COWRTV9')
     ...
     D separa          s            100a   inz(*all'-')
       ...
       *inlr  = *on;
       ...
       Data =
              '<br><br><b>COWRTV9 (Response)</b>'      + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
            + %trim(%char(%time():*iso));
       COWLOG_log( peBase : peNctw : Data );
