     ...
     D  this                         10a   overlay(PsDs:1)
       ...
       *inlr = *on;
       ...
       if SPVSPO_chkSpol( empr :sucu : peArcd: peSpol) = *OFF;
          %subst(@@repl:1:6) = arcd;
          %subst(@@repl:7:9) = spol;
       ...
       if SPVSPO_chkSspo( empr :sucu : peArcd: peSpol: peSspo) = *OFF;
          %subst(@@repl:1:3)  = sspo;
          %subst(@@repl:4:6)  = arcd;
        ...
        when acci = 'M';
             select;
              ...
              when colu = 'SA';
                   cpgm = 'PLQWEB20';
              when colu = 'QP';
               PLQWEB_marcarQuincenaPosteriorSuperpolizaEndoso( peBase
                                                              : peNrpl
                                                              : peArcd
                                                              : peSpol
                                                              : peSspo
