      ...
      * ------------------------------------------------------------ *
      * NWN NWN 16/05/19 : Agregado de nuevo campo CP1 de 29 con 9.  *
      *                    Asi no cancela la división....            *
      *                    Si el porcentaje es mayor a 100 queda en  *
      *                    la Salida 100.                            *
      *                                                              *
      * ************************************************************ *
       ...
       for x = 1 to 100;
        if diario(x).rama <> 0;
         ...
         if pr < 0;
          ...
          if diario(x).pane <> 0;
             cp1 = %dech((diario(x).comi/diario(x).pane)*100:29:9);
             if cp1 > 100;
             cp = 100;
             else;
             cp = cp1;
