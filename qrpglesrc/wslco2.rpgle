      ...
      * ************************************************************ *
      * WSLCO2 : Tareas generales.                                   *
      *          WebService - Retorna Lista de Propuesta en emision  *
      *                                                              *
      * ------------------------------------------------------------ *
      ...
      *                                                              *
      * ************************************************************ *
     Fctw00012  if   e           k disk
     Fctw00013  if   e           k disk
     Fctw00014  if   e           k disk
     ...
     D k0y000          ds                  likerec( c1w00014 : *key)
     D k1y000          ds                  likerec( c1w00014 : *key)
     D k12w000         ds                  likerec( c1w00012 : *key)
     D k13w000         ds                  likerec( c1w00013 : *key)
      ...
      *- Valido Orden de Lectura
       if not SVPWS_chkOrde ( 'WSLCO2' : peOrde : peMsgs );
         peErro = -1;
         return;
       endif;
       ...
       begsr posArc;
         ...
         select;
           when ( peOrde = 'NUMEROCOTI' );
             ...
             if ( peRoll = 'F' );
               setgt %kds ( k1y000 : 5 ) ctw00014;
             else;
               setll %kds ( k1y000 : 5 ) ctw00014;
             endif;
           when ( peOrde = 'ASEGUFECHA' );
             k12w000.w0empr = peBase.peEmpr;
             k12w000.w0sucu = peBase.peSucu;
             k12w000.w0nivt = peBase.peNivt;
             k12w000.w0nivc = peBase.peNivc;
             k12w000.w0nomb = pePosi.w0nomb;
             k12w000.w0fctw = pePosi.w0fctw;
             k12w000.w0nctw = pePosi.w0nctw;
             if ( peRoll = 'F' );
               setll %kds ( k12w000 : 7 ) ctw00012;
             else;
               setgt %kds ( k12w000 : 7 ) ctw00012;
             endif;
           when ( peOrde = 'INTERFECHA' );
             k13w000.w0empr = peBase.peEmpr;
             k13w000.w0sucu = peBase.peSucu;
             k13w000.w0nivt = peBase.peNivt;
             k13w000.w0nivc = peBase.peNivc;
             k13w000.w0fctw = pePosi.w0fctw;
             k13w000.w0nctw = pePosi.w0nctw;
             if ( peRoll = 'F' );
               setgt %kds ( k13w000 : 6 ) ctw00013;
             else;
               setll %kds ( k13w000 : 6 ) ctw00013;
             endif;
         endsl;
      ...
      *- Rutina de Lectura para Adelante
       begsr leeArc;
         ...
         select;
           when ( peOrde = 'NUMEROCOTI' );
             reade %kds ( k0y000 : 4 ) ctw00014;
           when ( peOrde = 'ASEGUFECHA' );
             readpe %kds ( k0y000 : 4 ) ctw00012;
           when ( peOrde = 'INTERFECHA' );
             reade %kds ( k0y000 : 4 ) ctw00013;
         endsl;
      ...
      *- Rutina de Lectura para Atras en caso de Paginado "F"
       begsr retArc;
         ...
         select;
           when ( peOrde = 'NUMEROCOTI' );
             readpe %kds ( k0y000 : 4 ) ctw00014;
           when ( peOrde = 'ASEGUFECHA' );
             reade %kds ( k0y000 : 4 ) ctw00012;
           when ( peOrde = 'INTERFECHA' );
             readpe %kds ( k0y000 : 4 ) ctw00013;
         endsl;
      ...
      *- Rutina de Posicionamiento en Comienzo de Archivo
       begsr priArc;
         ...
         select;
           when ( peOrde = 'NUMEROCOTI' );
             setll %kds( k0y000 : 4 ) ctw00014;
           when ( peOrde = 'ASEGUFECHA' );
             setgt %kds( k0y000 : 4 ) ctw00012;
           when ( peOrde = 'INTERFECHA' );
             setll %kds( k0y000 : 4 ) ctw00013;
         endsl;
