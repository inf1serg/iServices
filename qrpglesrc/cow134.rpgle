      ...
      **---------------------------------------------------------**
      *  COW134FM   Consulta de Scoring Vehiculos                 DSPF
      *  CTwer7     Cotización Web: Objetos Asegurados            PF
     ...
     * Define Archivos
      **---------------------------------------------------------**
     fcow134fm  cf   e             Workstn
     f                                     Sfile(Cow134cwa:NrSfl)
     f                                     InfDs(Iofb)
     fctwer7    if   e           k Disk
     fctw000    if   e           k Disk
     fset107    if   e           k Disk
      ...
      *----------------------------------------------------------------*
     d k1twer7         ds                  likerec(C1wer7:*key)
         ...
         //*--------------------------------------------------------*
          BegSr  ChgDtaSfl1;
              ...
              *in32 = '1';
              ...
              // asigna campos clave
              Clear k1twer7;
              k1twer7.r7empr = peEmpr;
              k1twer7.r7sucu = peSucu;
              k1twer7.r7nivt = %Dec(peNivt:1:0);
              k1twer7.r7nivc = %Dec(peNivc:5:0);
              k1twer7.r7nctw = %Dec(peNctw:7:0);
              k1twer7.r7rama = %Dec(peRama:2:0);
              k1twer7.r7arse = %Dec(peArse:2:0);
              k1twer7.r7poco = %Dec(pePoco:4:0);
              k1twer7.r7riec = peRiec;
              k1twer7.r7xcob = %Dec(pexCob:3:0);
              // Posici7namiento
              Setll %kds(k1twer7:10) CTwer7;
              // Lectura de CTwet1
                 Reade %kds(k1twer7:10) CTwer7;
