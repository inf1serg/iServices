      ...
      * ************************************************************ *
      * WSLAXC : WebService - Retorna Aseg.relac.a intermed.x CUIT.  *
      * ------------------------------------------------------------ *
      * Norberto Franqueira                            21/08/2015    *
      * ------------------------------------------------------------ *
      * Modificaciones:                                              *
      ...
      *- Rutina de Posicionamiento de Archivo. Segun pePosi, peRoll
       begsr posArc;
        ...
        khase.asempr = peBase.peEmpr;
        khase.assucu = peBase.peSucu;
        khase.asnivt = peBase.peNivt;
        khase.asnivc = peBase.peNivc;
        khase.ascuit = pePosi.ascuit;
        khase.asasen = pePosi.asasen;

       if ( peRoll = 'F' );
          setgt %kds ( khase : 6 ) pahas102;
       else;
          setll %kds ( khase : 6 ) pahas102;
       endif;
