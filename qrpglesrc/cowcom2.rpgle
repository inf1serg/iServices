     ...
     D CRLF            s              4a   inz('<br>')
     D separa          s            100a
     D pePoco          ds                  likeds( UbicPoc2_t ) dim(10)
     D pePocoC         s             10i 0
     D AS400Sys        s             10a
     ...
     D                 pi
       ...
       Data = CRLF                                     + CRLF
            + '<b>COWCOM2</b>'
            + '<b> Renovación Comercio  (Request)</b>' + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
      ...
      /free
       ...
       for i = 1 to 10;
         ...
         Data = '&nbspPEPOCO(' + %trim(%char(i)) + ')' + CRLF
              ...
              + '&nbsp&nbsp;CTAR: ' + %editc(pePoco(i).Ctar:'X') + CRLF
              + '&nbsp&nbsp;CTA1: ' + %trim(pePoco(i).Cta1)      + CRLF
              + '&nbsp&nbsp;CTA2: ' + %trim(pePoco(i).Cta2)      + CRLF
              + '&nbsp&nbsp;CLFR: ' + %trim(pePoco(i).clfr)      + CRLF
              + '&nbsp&nbsp;CAGR: ' + %editc(pePoco(i).cagr:'X')+ CRLF
      ...
      * ------------------------------------------------------------------ *
      * setCOWCOM1 : Llamada a Wrapper COWCOM1 - Cotizar                   *
      *                                                                    *
      * Retorna *on = Ok / *off = Error                                    *
      * ------------------------------------------------------------------ *
     P setCOWCOM1...
     ...
     D                 pi              n
      /free
       ...
       Data = CRLF + CRLF
            + '<b>COWCOM1 '
            + 'Cotización Comercio  (Request)</b>'          + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
            + %trim(%char(%time():*iso))                    + CRLF
            + 'PEBASE'                                      + CRLF
      ...
      * ------------------------------------------------------------------ *
      * setErrorCOWCOM2 : Llamada a Wrapper COWCOM2 - Error.               *
      *                                                                    *
      * Retorna *on = Ok / *off = Error                                    *
      * ------------------------------------------------------------------ *
     P setErrorCOWCOM2...
     ...
     D                 pi
      /free
       ...
       Data = '<br><br><b>COWCOM2 (Response)</b> : Error' + CRLF
            + 'Fecha/Hora: '
            + %trim(%char(%date():*iso)) + ' '
            + %trim(%char(%time():*iso))                  + CRLF
            + 'PEERRO: ' +  %trim(%char(peErro))          + CRLF
