      ...
      *  Fecha         : 2020/01/21
      *  Abr.Dev.      :
      *  Objetivo      : Consulta de Accesorios
      *
      *
      *  Project Name  :
      *  Work ID       :
      ...
      **---------------------------------------------------------**
      *  COW125FM   Consulta de Accesorios de Vehiculos           DSPF
      *  CTWET1     Cotización Web: Accesorios Vehículos          PF
     ...
     * Define Archivos
      **---------------------------------------------------------**
     fcow125fm  cf   e             Workstn
     f                                     Sfile(Cow125cwa:NrSfl)
     f                                     InfDs(Iofb)
     fctwet1    if   e           k Disk
     fctw000    if   e           k Disk
      *---------------------------------------------------------------*
         ...
         //*--------------------------------------------------------*
          BegSr  ChgDtaSfl1;
              ...
              *in32 = '1';
              ...
              // asigna campos clave
              Clear k1twet1;
              k1twet1.t1empr = peEmpr;
              k1twet1.t1sucu = peSucu;
              k1twet1.t1nivt = %Dec(peNivt:1:0);
              k1twet1.t1nivc = %Dec(peNivc:5:0);
              k1twet1.t1nctw = %Dec(peNctw:7:0);
              k1twet1.t1rama = %Dec(peRama:2:0);
              k1twet1.t1arse = %Dec(peArse:2:0);
              k1twet1.t1poco = %Dec(pePoco:4:0);
              // Posicionamiento
              Setll %kds(k1twet1:8) CTwet1;
              // Lectura de CTwet1
                 Reade %kds(k1twet1:8) CTwet1;
